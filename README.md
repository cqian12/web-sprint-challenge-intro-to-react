...
React is a JS library that builds a virtual DOM to eliminate much of the need of manually manipulating DOM elements through the use of components. React is used to tell the virtual DOM which elements and state to render to the DOM, and then using a reconcilation process React will detect changes in state and update the virtual DOM accordingly.  
2. Describe component state.
state is the object in a component that allows the component to be dynamic and responsive to changes. Whenever the state changes (due to changes in variables, user input, etc.), certain actions will occur within the component depending on what the code says to do.
3. Describe props.
props are properties passed from parent components to child components.
4. What are side effects, and how do you sync effects in a React component to changes of certain state or props?
Side effects are changes that occur outside of the scope of a function that's being executed. To sync effects, you would use hooks.